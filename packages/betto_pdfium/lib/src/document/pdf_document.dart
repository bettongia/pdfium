...
/// `dart:isolate` is not supported on any compile target, so PDFium calls
/// run inside a dedicated Web Worker instead, communicating with the main
/// thread via a hand-rolled `postMessage` protocol.
///
/// ## Future capabilities
///
